...
class GenericSignal {
     ...
     */
    constructor(eventId, segmentType, signalType) { 
     ...
     */
    static initialize(obj, eventId, segmentType, signalType) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('segment_type')) {
                obj['segment_type'] = ApiClient.convertToType(data['segment_type'], 'String');
            }
            if (data.hasOwnProperty('signal_type')) {
                obj['signal_type'] = ApiClient.convertToType(data['signal_type'], 'String');
            }
