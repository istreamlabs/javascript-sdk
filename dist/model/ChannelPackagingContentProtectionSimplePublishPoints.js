...
/**
 * The ChannelPackagingContentProtectionSimplePublishPoints model module.
 * @module model/ChannelPackagingContentProtectionSimplePublishPoints
 * @version 0.0.0
 */
var ChannelPackagingContentProtectionSimplePublishPoints = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ChannelPackagingContentProtectionSimplePublishPoints</code>.
   * @alias module:model/ChannelPackagingContentProtectionSimplePublishPoints
   */
  function ChannelPackagingContentProtectionSimplePublishPoints() {
    _classCallCheck(this, ChannelPackagingContentProtectionSimplePublishPoints);

    ChannelPackagingContentProtectionSimplePublishPoints.initialize(this);
  }
  /**
  ...
  _createClass(ChannelPackagingContentProtectionSimplePublishPoints, null, [{
    key: "initialize",
    value: function initialize(obj) {}
    /**
     * Constructs a <code>ChannelPackagingContentProtectionSimplePublishPoints</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChannelPackagingContentProtectionSimplePublishPoints} obj Optional instance to populate.
     * @return {module:model/ChannelPackagingContentProtectionSimplePublishPoints} The populated <code>ChannelPackagingContentProtectionSimplePublishPoints</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ChannelPackagingContentProtectionSimplePublishPoints();
  ...
  return ChannelPackagingContentProtectionSimplePublishPoints;
}();
/**
...
ChannelPackagingContentProtectionSimplePublishPoints.prototype['basic_auth'] = undefined;
/**
 ...
 * @member {module:model/ChannelPackagingContentProtectionSimplePublishPoints.CompressionEnum} compression
 */

ChannelPackagingContentProtectionSimplePublishPoints.prototype['compression'] = undefined;
/**
...
ChannelPackagingContentProtectionSimplePublishPoints.prototype['cross_playback_paths'] = undefined;
/**
 * (Optional) Specifies if this pubpoint should not be monitored by PLM.
 * @member {Boolean} do_not_monitor
 */

ChannelPackagingContentProtectionSimplePublishPoints.prototype['do_not_monitor'] = undefined;
/**
 * Allows custom HTTP headers to be set via configuration for all HTTP requests.
 * @member {Object.<String, String>} headers
 */

ChannelPackagingContentProtectionSimplePublishPoints.prototype['headers'] = undefined;
/**
...
ChannelPackagingContentProtectionSimplePublishPoints.prototype['method'] = undefined;
/**
...
ChannelPackagingContentProtectionSimplePublishPoints.prototype['playback_base_url'] = undefined;
/**
...
ChannelPackagingContentProtectionSimplePublishPoints.prototype['playback_query_params'] = undefined;
/**
...
ChannelPackagingContentProtectionSimplePublishPoints.prototype['publish_base_url'] = undefined;
/**
...
ChannelPackagingContentProtectionSimplePublishPoints['CompressionEnum'] = {
  /**
   * value: "NONE"
   * @const
   */
...
var _default = ChannelPackagingContentProtectionSimplePublishPoints;
