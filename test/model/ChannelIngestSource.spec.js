...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IStreamPlanetChannelsApi.ChannelIngestSource();
  });
  ...
  describe('ChannelIngestSource', function() {
    it('should create an instance of ChannelIngestSource', function() {
      ...
      //var instance = new IStreamPlanetChannelsApi.ChannelIngestSource();
      //expect(instance).to.be.a(IStreamPlanetChannelsApi.ChannelIngestSource);
    });
