...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IStreamPlanetChannelsApi.PutChannelRequest();
  });
  ...
  describe('PutChannelRequest', function() {
    it('should create an instance of PutChannelRequest', function() {
      ...
      //var instance = new IStreamPlanetChannelsApi.PutChannelRequest();
      //expect(instance).to.be.a(IStreamPlanetChannelsApi.PutChannelRequest);
    });
